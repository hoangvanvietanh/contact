...
CREATE TABLE `email_contacts` (
  ...
  `email_contact_name` varchar(45) NOT NULL,
  PRIMARY KEY (`email`),
  KEY `fk_email_contacts_1_idx` (`email_contact_name`),
  CONSTRAINT `fk_email_contacts_1` FOREIGN KEY (`email_contact_name`) REFERENCES `contact` (`name`)
...
INSERT INTO `email_contacts` VALUES ('khanh@gmail.com','Khanh');
